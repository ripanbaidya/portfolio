...
export const technologies: Technology[] = [
  ...
  { name: "MySQL", icon: "mysql", colorClassName: "text-[#4479A1]" },
  { name: "MongoDB", icon: "mongodb", colorClassName: "text-[#47A248]" },
  { name: "Redis", icon: "redis", colorClassName: "text-[#DC382D]" },

  // Cloud & DevOps
  { name: "GCP", icon: "googlecloud", colorClassName: "text-[#4285F4]" },
  { name: "AWS", icon: "aws", colorClassName: "text-[#FF9900]" },
  ...
  { name: "Linux", icon: "linux", colorClassName: "text-[#FCC624]"},
];
